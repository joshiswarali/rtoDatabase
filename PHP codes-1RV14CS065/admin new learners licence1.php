...
{
   if($driver_licence['licenceid']==NULL && (strcmp($driver_licence['type'],"2 Wheeler Learner's")==0 || strcmp($driver_licence['type'],"4 Wheeler Learner's")==0))
 {
...
<div class="container">
<form action="admin new learners licence2.php" method="post">
    <p>
